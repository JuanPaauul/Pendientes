...
var cant = document.querySelector("#cant-items");
var price = document.querySelector("#precio-items");
var state = document.querySelector("#codigo-estado");
var description = document.querySelector("#descripcion-items");
/*UT               	6.65%
NV               	8.00%
TX                	6.25%
AL                	4.00%
